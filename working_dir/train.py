...
from task_utils import get_batch_function_for_multilingual_training
...
# data
#dataset = "europarl"#'openwebtext'
list_of_datasets = ["europarl", "multiun"]
# additional data
xlm_alpha = 0.3
...
data_dir = [os.path.join('data', dataset) for dataset in list_of_datasets]
...
get_batch = get_batch_function_for_multilingual_training(
        data_dir, data_bin_dtype, xlm_alpha, block_size, batch_size, device
)
...
#scale = torch.full((), init_scale, dtype=torch.float32, device=dev)
