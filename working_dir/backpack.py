...
if __name__ == '__main__':
    ...
    lm = BackpackLM(BackpackLMConfig(
        block_size=256, vocab_size=10, n_layer=6, n_head=6, n_embd=384, n_sense_vector=8
    ))
    print("Num params of nano bkp with 8 senses: ",lm.get_num_params())

    lm = BackpackLM(BackpackLMConfig(
        block_size=256, vocab_size=10, n_layer=6, n_head=6, n_embd=384, n_sense_vector=16
    ))
    print("Num params of nano bkp with 16 senses: ",lm.get_num_params())

    lm = BackpackLM(BackpackLMConfig(
        block_size=256, vocab_size=10, n_layer=12, n_head=12, n_embd=768, n_sense_vector=8
    ))
    print("Num params of standard bkp with 8 senses: ",lm.get_num_params())

    lm = BackpackLM(BackpackLMConfig(
        block_size=256, vocab_size=10, n_layer=12, n_head=12, n_embd=768, n_sense_vector=16
    ))
    print("Num params of standard bkp with 16 senses: ",lm.get_num_params())
    # x = torch.zeros((1, 384), dtype=torch.int)
